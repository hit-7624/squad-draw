      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-lg font-sans">
            This text should use the Caudex font. The quick brown fox jumps over
            the lazy dog.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-lg font-serif">
            This text should use the Handlee font. The quick brown fox jumps
            over the lazy dog.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-lg font-mono">
            This text should use the Didact Gothic font. The quick brown fox
