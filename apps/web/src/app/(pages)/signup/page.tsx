...
export default function SignUpPage() {
  ...
  const handleGitHubSignUp = async () => {
    try {
      ...
      setGeneralError("Failed to sign up with GitHub")
    }
  }
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-border-1 rounded-lg bg-bg-2 text-font-1 hover:bg-bg-1 transition-colors"
            >
